        ...
        btnAddReceipt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(op == 0) {
                    ...
                    try {
                        new AddReceipt().add(receiptIDValue, dateValue, amountValue, kindValue, companyValue, countryValue, cityValue, streetValue, numberValue, current_taxpayer.taxRegistrationNumber);
